...
namespace GTFSTools.GIS
{
    public class SQLite
    {
        public static void CreateFile(System.Data.DataTable DataTable, String FileName)
        {
            System.Data.SQLite.SQLiteConnection.CreateFile(FileName);
            var sqliteConnection = new System.Data.SQLite.SQLiteConnection(String.Format("Data Source={0};Version=3;", FileName));
            ...
            var populateGeometryColumns = new System.Data.SQLite.SQLiteCommand(String.Format("insert into geometry_columns (f_table_name, f_geometry_column, geometry_type, coord_dimension, srid, geometry_format) values ('{0}', 'WKT', 2, 2, 4326, 'WKT')", dataTableName), sqliteConnection);
